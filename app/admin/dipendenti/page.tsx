      ...
      {magicLink && (
        <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden p-6 text-center animate-fade-in">
            ...
            <Button onClick={() => { setMagicLink(null); setIsModalOpen(false); }} className="w-full">
              Chiudi
            </Button>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md animate-slide-in">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <Input 
                ...
                required 
                placeholder="mario.rossi@dieffe.tech"
                helperText={!editingDipendente ? "Verrà inviata una mail di invito." : undefined}
              />

              <Select
                label="Ruolo"
                name="ruolo"
                defaultValue={editingDipendente?.ruolo || 'dipendente'}
                options={[
              ...
              {/* Esempio di Checkbox se volessi gestire lo stato attivo */}
              {<Checkbox 
