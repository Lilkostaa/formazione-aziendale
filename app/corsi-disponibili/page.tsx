...
export default function EmployeeDashboard() {
    ...
    const handleSubscribe = async (corsoId: number) => {
        ...
        try {
            ...
            // Ricarica i dati per aggiornare lo stato del corso e i contatori
            fetchDashboard(session.user.id)
                                ...
                                <div className="p-5 flex-1 flex flex-col">
                                    ...
                                    <div className="mt-auto flex items-center justify-between pt-4 border-t border-gray-50">
                                        ...
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${corso.stato_iscrizione === 'disponibile'
